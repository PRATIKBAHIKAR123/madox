...
const Overview: React.FC<OverviewProps> = ({ beds, baths, sqft }) => { 
  return (
    <div className="bg-white p-8 mb-2">
      ...
      <div className="flex gap-4 mt-2 justify-center">
        <div className="overflow-hidden flex flex-col gap-2 items-center">
          <Bed/>
          <div className="text-[#222222] text-sm font-medium font-['Roboto'] leading-tight">{beds} Bedrooms</div>
        </div>

        <div className="overflow-hidden flex flex-col gap-2 items-center">
          <Bath/>
          <div className="text-[#222222] text-sm font-medium font-['Roboto'] leading-tight">{baths} Bathrooms</div>
        </div>
        ...
        <div className="overflow-hidden flex flex-col gap-2 items-center">
          <Box/>
          <div className="text-[#222222] text-sm font-medium font-['Roboto'] leading-tight">{sqft} ft</div>
        </div>
